...
class FileOrganizerLogic:
    ...
    def get_target_files(self):
        return [f for f in os.listdir(self.src_dir) if os.path.isfile(os.path.join(self.src_dir, f))] if os.path.exists(self.src_dir) else []
...
if __name__ == '__main__':
    ...
    print("🚀 Webサーバーが起動しました！ブラウザで http://localhost:8080 を開いてください。")
